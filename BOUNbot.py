...
#Upload the .json file before running this cell
def pull_Intent(user_input) -> str:
  """Sends the user_input to Dialogflow and returns the classified intent as a string"""
...
"""Prints the intent pulled from the dialogflow api function to check if it returns the intent name as a string. This code works."""
#classified_intent = pull_Intent(user_input)[0]
#print(classified_intent)

#TESTING IF FUNCTION RETURNS ENTITY
"""Prints the entity value pulled from the dialogflow api function to check if it returns the entity value as a string. This code does not work."""
#entity_value = pull_Intent(user_input)[1]
#print(entity_value)

#LOCATION ANSWERS
"""This dictionary isolates the entity by using RegEx and matches it with a response according to the intent."""
chat_loc=  [
...
#LOCATION FUNCTION
"""This function prints the response according to the correct intent."""
def loc_Answer(str):
...
"""This function is meant to take the entity value pulled from Dialogflow as a string and then use it as a key to match with the correct answer value.  Then
it returns the value as a string. This function does not work, but would work if we could pull the entity value as a string."""
...
"""This function generates transition sentences using CFGs, we added this to show our work. This function works, but is not used in the responses of the chatbot."""
#def label_CFG():
...
#CFG FUNCTION UNIT TEST
"""Checks if the CFG function generates sentences."""
#print(label_CFG())

#LABEL ANSWER MAIN FUNCTION
"This function is meant to append the strings returned from the dictionary and CFG functions. It does not work because of the entity values issue."
...
#MAIN
"""Our code starts by printing a greeting and asking for user input. Then it classifies the input to print a single response. Later, it goes into a loop which stops
only when the intent is classified as endConverstion. As long as the loop keeps going the program keeps taking input, classifying it, and printing an appropriate
response."""
